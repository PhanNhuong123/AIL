...
fn make_module(id: &str, name: &str, description: &str, fns: Vec<FunctionJson>) -> ModuleJson {
...
fn make_fn(id: &str, name: &str, status: Status, steps: Option<Vec<StepJson>>) -> FunctionJson {
    FunctionJson {
        id: id.to_string(),
        name: name.to_string(),
        status,
...
fn make_step(id: &str, name: &str, intent: &str) -> StepJson {
    StepJson {
        id: id.to_string(),
        name: name.to_string(),
        status: Status::Ok,
...
fn graph_with_modules(modules: Vec<ModuleJson>) -> GraphJson {
